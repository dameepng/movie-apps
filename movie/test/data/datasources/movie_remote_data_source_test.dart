...
void main() {
  ...
  group('get Now Playing Movies', () {
    ...
    test('should return list of Movie Model when the response code is 200',
        () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$baseUrl/movie/now_playing?$API_KEY')))
          .thenAnswer((_) async =>
  ...
  group('get Popular Movies', () {
    ...
    test('should return list of movies when response is success (200)',
        () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$baseUrl/movie/popular?$API_KEY')))
          .thenAnswer((_) async =>
  ...
  group('get Top Rated Movies', () {
    ...
    test('should return list of movies when response code is 200 ', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$baseUrl/movie/top_rated?$API_KEY')))
          .thenAnswer((_) async =>
  ...
  group('get movie detail', () {
    ...
    test('should return movie detail when the response code is 200', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$baseUrl/movie/$tId?$API_KEY')))
          .thenAnswer((_) async =>
  ...
  group('get movie recommendations', () {
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      // arrange
      when(mockHttpClient
              .get(Uri.parse('$baseUrl/movie/$tId/recommendations?$API_KEY')))
  ...
  group('search movies', () {
    ...
    test('should return list of movies when response code is 200', () async {
      // arrange
      when(mockHttpClient
              .get(Uri.parse('$baseUrl/search/movie?$API_KEY&query=$tQuery')))
          .thenAnswer((_) async => http.Response(
